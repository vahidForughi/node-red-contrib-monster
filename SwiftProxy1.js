...
module.exports = function(RED) {
    ...
    function createRequestWrapper(node,req) {
        ...
        toWrap.forEach(function(f) {
            if (typeof req[f] === "function") {
                wrapper[f] = function() {
                    node.warn(RED._("swift-proxt.errors.deprecated-call",{method:"msg.req."+f}));
    ...
    function createResponseWrapper(node,res) {
        ...
        toWrap.forEach(function(f) {
            wrapper[f] = function() {
                node.warn(RED._("swift-proxt.errors.deprecated-call",{method:"msg.res."+f}));
    ...
    function SwiftProxy(n) {
        ...
        if (RED.settings.httpNodeRoot !== false) {
            ...
            if (!n.url) {
                this.warn(RED._("swift-proxt.errors.missing-path"));
                return;
            }
            this.url = n.url;
            if (this.url[0] !== '/') {
            ...
            const prefix = "/proxy5";
            this.url1 = this.url + "/info1";
            this.url2 = this.url + "/info2";
            this.url3 = this.url + "/info3";
            ...
            // const prefix = "/proxy5"
            // this.url = "/info";
            // this.url = prefix + "/auth/v1.0/";
            // RED.httpNode.get(this.url ,cookieParser(),httpMiddleware,corsHandler,metricsHandler,this.callback,this.errorHandler);
            RED.httpNode.get(this.url1 ,cookieParser(),httpMiddleware,corsHandler,metricsHandler,this.callback,this.errorHandler);
            RED.httpNode.get(this.url2 ,cookieParser(),httpMiddleware,corsHandler,metricsHandler,this.callback,this.errorHandler);
            RED.httpNode.get(this.url3 ,cookieParser(),httpMiddleware,corsHandler,metricsHandler,this.callback,this.errorHandler);
            // if (this.method == "get") {
            //     RED.httpNode.get(this.url,cookieParser(),httpMiddleware,corsHandler,metricsHandler,this.callback,this.errorHandler);
            ...
            this.warn(RED._("swift-proxt.errors.not-created"));
        }
    }
